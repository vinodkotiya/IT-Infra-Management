<%@ Page Language="VB" AutoEventWireup="false" CodeFile="matrix.aspx.vb" Inherits="_matrix" %>
  ...
  <div class="container">
    <div class="row">
      <div class="grid_12">
        ...
        --%>  <div class="banners">
            <a href="upload/mail.jpg" class="banner" target="_blank" >
              <img src="images/email1.png" alt="" />
              <div class="bann_capt"><span>Email Matrix</span></div>
            </a>
            <a href="upload/POWERTEL Escalation Matrix.pdf" class="banner" target="_blank" >
              <img src="images/itasset1.jpg" alt="" />
              <div class="bann_capt"><span>Powergrid Matrix</span></div>
            </a>
            <a href="upload/matrix IT-Communication.xls" class="banner" target="_blank" >
              <img src="images/ad.jpg" alt="" />
              <div class="bann_capt"><span>IT Communication</span></div>
            </a>
            <a href="upload/matrix AD.pdf" class="banner" target="_blank">
              <img src="images/ad.jpg" alt="" />
