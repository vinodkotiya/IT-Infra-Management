<%@ Page Language="VB" AutoEventWireup="false" CodeFile="m_hospital.aspx.vb" Inherits="_m_hospital" %>
...
<!-- Main -->
            ...
            <ContentTemplate>
						<div class="inner">
							<h1>Empanelled Hospital</h1>
                            <p>Source: sanjeevani.ntpc.co.in</p>
						<%--	<span class="image main"><img src="images/pic13.jpg" alt="" /></span>--%>
                             Select Region: <asp:RadioButtonList width="80%"  ID="rblRegion" DataTextField="region" DataValueField="region" runat="server" RepeatColumns="3"  AutoPostBack="True" ></asp:RadioButtonList>
                             <asp:GridView width="80%" ID="gvhospital" runat="server" >
    </asp:GridView>
